 ...
 */
final class Version20250918081256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attraction (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, route VARCHAR(255) DEFAULT NULL, INDEX IDX_D503E6B812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE favorite (id INT AUTO_INCREMENT NOT NULL, attraction_id INT NOT NULL, date DATE NOT NULL, INDEX IDX_68C58ED93C216F9D (attraction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, attraction_id INT NOT NULL, name VARCHAR(255) NOT NULL, date_upload DATE NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_14B784183C216F9D (attraction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE route_attraction (id INT AUTO_INCREMENT NOT NULL, attraction_id INT NOT NULL, route_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_DB742C5F3C216F9D (attraction_id), INDEX IDX_DB742C5F34ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
